...
QCC:
Why is the total distribution only 99.8%?
HOW THIS SCRIPT WORKS:
Move occupations.csv in the directory of the script with occupation name and percentage as columns. Call select_random() to choose a random occupation. The chance to select each occupation is weighted based on the percentage in the csv file.
'''
